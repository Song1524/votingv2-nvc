...
function loadVotes() {
    fetch("https://votingv2-nvc-production.up.railway.app/api/votes", {
        method: "GET",
        headers: {
...
function togglePublic(voteId, btn) {
    fetch(`https://votingv2-nvc-production.up.railway.app/api/votes/${voteId}/toggle-public`, {
        method: "PATCH",
        headers: {
            "Authorization": "Bearer " + accessToken
        }
...
function moveToTrash(voteId) {
    ...
    fetch(`https://votingv2-nvc-production.up.railway.app/api/votes/${voteId}/trash`, {
        method: "PATCH",
        headers: {
            "Authorization": "Bearer " + accessToken
        }
