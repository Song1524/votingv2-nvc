...
function loadDeletedVotes() {
    fetch("https://votingv2-nvc-production.up.railway.app/api/votes/deleted", {
        method: "GET",
        headers: {
...
function deletePermanently(id) {
    ...
    fetch(`https://votingv2-nvc-production.up.railway.app/api/votes/${id}/force`, {
        method: "DELETE",
        headers: {
            "Authorization": "Bearer " + accessToken
        }
...
function restoreVote(id) {
    ...
    fetch(`https://votingv2-nvc-production.up.railway.app/api/votes/${id}/restore`, {
        method: "PATCH",
        headers: {
            "Authorization": "Bearer " + accessToken
        }
