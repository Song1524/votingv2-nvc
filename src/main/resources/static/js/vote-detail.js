...
if (!voteId) {
    ...
    fetch(`https://votingv2-nvc-production.up.railway.app/api/votes/${voteId}`, {
...
document.getElementById("vote-form").addEventListener("submit", async e => {
    ...
    try {
        const res = await fetch(`https://votingv2-nvc-production.up.railway.app/api/votes/${voteId}/vote`, {
            method: "POST",
            headers: {
